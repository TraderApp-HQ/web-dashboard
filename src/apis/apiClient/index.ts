...
export class APIClient {
  ...
  private async request<T>(method: string, url: string, data?: any, options?: RequestOptions): Promise<T> {
    ...
    const requestOptions: RequestInit = {
      ...
      headers: {
        ...
        ...(isAuthenticated && getAccessToken() ? { Authorization: `Bearer ${getAccessToken()}` } : {}),
      },
      ...options,
    };
