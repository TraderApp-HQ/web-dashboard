...
interface DropdownMenuProps {
  ...
  classNames?: Partial<Record<"rootClass" | "dropDownClass" | "dropDownItemClass" | "triggerBtnClass", string>>;
  className?: string;
}

const DropdownMenu: React.FC<DropdownMenuProps> = ({ trigger, children, classNames, className }) => {
