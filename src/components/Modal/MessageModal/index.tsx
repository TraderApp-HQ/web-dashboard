...
export default function MessageModal({ title, description, icon: Icon, openModal, onClose }: DeleteModalProps) {
  const handleMeClose = () => {
    if (onClose) {
      onClose();
    }
  ...
  return (
    <Modal title={title} description={description} openModal={openModal} width="md:w-[445px]" onClose={handleMeClose}>
