...
const WalletType: React.FC<CustomWalletTypeParam> = ({
	...
	return (
		<div ref={ref} className={clsx("dropdown w-full cursor-pointer", className)}>
			<div
				onClick={handleClick}
				className={clsx(
					"flex justify-between border-0 items-center border-[#DEE3F6] p-1 rounded",
				)}
			>
			...
			<div
				className={clsx(
					"z-10 dropdown-content bg-white divide-y absolute divide-gray-100 rounded-lg shadow w-5/6",
					isOpen ? "block" : "hidden",
				)}
			>
