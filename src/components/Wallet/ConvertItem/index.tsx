...
export default function ConvertItem({ className, assets, selectedDefault, onSelected, title }: ConvertItemParam) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center my-2">
        <CustomSelect className="w-24" assets={assets} onSelected={handleSelect} selectedDefault={selectedAsset} />
        <RoundedTextDiv className=" w-44 h-[35px] rounded-md px-3 bg-[#FFFFFF]">
          ...
          />
          <h3 className="text-[#808080] text-[13px] flex items-center">{selectedAsset?.shortName}</h3>
        </RoundedTextDiv>
      </div>
