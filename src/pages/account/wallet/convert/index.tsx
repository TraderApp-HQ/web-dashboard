...
export default function () {
  ...
  return (
    <>
      <Modal openModal={openModal} width="md:w-[450px]" onClose={onClose} title="Convert Currency">
        <div className="space-y-5">
          <ConvertItem assets={assets} selectedDefault={fromAsset} onSelected={onFromAssetSelected} title="You Sell" />
          <div className="flex justify-center cursor-pointer" onClick={handleSwap}>
            <ArrowSwap />
          </div>
          <ConvertItem assets={assets} selectedDefault={toAsset} onSelected={onToAssetSelected} title="You Buy" />
