...
const Profile = () => {
  const { userProfile, userEmail, userFirstNameInitials, userLastNameInitials, userFullName } = useUserProfileData();

  return (
    <div>
      <div className="w-12/12 lg:w-10/12 2xl:w-10/12">
        <ProfileTextAndSubText mainText="Personal info" subText="Update your photo and personal details here." />
      </div>
      <div className="mt-6 border-b" />
      <div className="mt-10 mb-6">
        <ProfileTextAndSubText mainText="Your photo" subText="This will be displayed on your profile." />
      </div>
      <div>
        <UserTile
