	...
	return (
		<div>
			...
			<div className="mt-10 mb-6 border-b">
				<ProfileTextAndSubText
					mainText="Notify me"
					subText="Receive important notification."
				/>
				<div className="mt-6 mb-6">
					<SystemsNotificationOption
						optionLabel={"When a new signal is posted"}
						checked={undefined}
					/>
					<SystemsNotificationOption
						optionLabel={"When I enter a trade"}
						checked={undefined}
					/>
					<SystemsNotificationOption
						optionLabel={"When I exit a trade"}
						checked={undefined}
					/>
					<SystemsNotificationOption
						optionLabel={"When Other relevant notifications"}
						checked={undefined}
					/>
				</div>
			</div>
