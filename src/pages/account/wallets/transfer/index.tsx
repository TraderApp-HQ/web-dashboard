...
export default function () {
	...
	const [fromWallet, setFromWallet] = useState(
		wallets.filter((wallet) => wallet?.name === "Main Wallet")[0],
	);
	const [toWallet, setToWallet] = useState(
		wallets.filter((wallet) => wallet?.name === "Trading Wallet")[0],
	);
					...
					<div className="w-full py-4 px-3 rounded-2xl border border-[#D1D7F0] bg-white flex-col space-y-3">
						<div className="flex justify-between text-sm">
							...
							<div>
								<WalletType
									wallets={wallets}
									selectedDefault={fromWallet}
									onSelected={onFromWalletSelected}
								/>
							</div>
						</div>
						...
						<div className="flex justify-between text-sm">
							...
							<div>
								<WalletType
									wallets={wallets}
									selectedDefault={toWallet}
									onSelected={onToWalletSelected}
								/>
							</div>
						</div>
					</div>
