		...
		<div>
			...
			{stats && (
				<div className="flex flex-col gap-2 relative">
					...
					<button
						className="lg:hidden md:w-4/12 bg-[#1836B2] hover:bg-[#152b8f] active:bg-[#152b8f] text-white font-bold py-4 px-6 rounded-lg transition-colors duration-200 mb-4"
